...
class AssetTypeOverviewHandler implements RequestHandlerInterface
{
    ...
    public function handle(ServerRequestInterface $request) : ResponseInterface
    {
        ...
        $data = $this->getAsset()->listAssetTypes($offset, $per_page, $search_term);
        $total = $this->getAsset()->countTypes($search_term);
        $data['total'] = $total;
    ...
    /**
     * @param Asset $asset
     * @return AssetTypeOverviewHandler
     */
    public function setAsset(Asset $asset): AssetTypeOverviewHandler
    {
        $this->asset = $asset;
        return $this;
    }
