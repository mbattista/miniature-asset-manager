...
class PlaceUpdateHandler implements RequestHandlerInterface
{
    ...
    public function handle(ServerRequestInterface $request) : ResponseInterface
    {
        ...
        if (isset($json_body['longitude']) && is_string($json_body['longitude'])) {
            ...
            $this->getPlace()->setLongitude(null);
        }
        ...
        if (isset($json_body['latitude']) && is_string($json_body['latitude'])) {
            ...
            $this->getPlace()->setLatitude(null);
        }
        ...
        if (isset($json_body['postcode']) && is_string($json_body['postcode'])) {
            ...
            $this->getPlace()->setPostcode(null);
        }
        ...
        if (isset($json_body['opening_times']) && is_string($json_body['opening_times'])) {
            ...
            $this->getPlace()->setOpeningTimes(null);
        }
        ...
        if (isset($json_body['active']) && is_bool($json_body['active'])) {
            ...
            $errored = true;
            $error_message = ['active' => 'required'];
        }

        if (!$errored) {
            $this->getPlace()->update();
    ...
    /**
     * @param Place $place
     * @return PlaceUpdateHandler
     */
    public function setPlace(Place $place): PlaceUpdateHandler
    {
        $this->place = $place;
        return $this;
    }
     ...
     * @return PlaceUpdateHandler
     */
    public function setCitrix(Citrix $citrix): PlaceUpdateHandler
    {
        $this->citrix = $citrix;
        return $this;
    }
