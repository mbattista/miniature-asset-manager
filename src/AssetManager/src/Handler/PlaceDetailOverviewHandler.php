...
class PlaceDetailOverviewHandler implements RequestHandlerInterface
{
    ...
    public function handle(ServerRequestInterface $request) : ResponseInterface
    {
        ...
        $data = $this->getPlace()->listDetailOverview($offset, $per_page, $search_term);
        $total = $this->getPlace()->countDetailOverview($search_term);
        $data['total'] = $total;
    ...
    /**
     * @param Place $place
     * @return PlaceDetailOverviewHandler
     */
    public function setPlace(Place $place): PlaceDetailOverviewHandler
    {
        $this->place = $place;
        return $this;
    }
