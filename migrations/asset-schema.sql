...
CREATE FUNCTION public.asset_list_view_asset_place_delete_trigger() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
    INSERT INTO asset_list_table (
...
CREATE TABLE public.places_assets (
    ...
    external_person character varying
);
...
--
-- Name: asset_list_from_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX asset_list_from_idx ON public.asset_list_table USING btree (from_datetimez);
...
--
-- Name: fki_places_assets_external_person; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX fki_places_assets_external_person ON public.places_assets USING btree (external_person);
...
--
-- Name: places_assets_external_person_trgm_gin; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX places_assets_external_person_trgm_gin ON public.places_assets USING gin (external_person public.gin_trgm_ops);
...
INSERT INTO person (last_name, first_name) VALUES ('admin','admin');
INSERT INTO asset_user (person_id, email, password, deactivated, is_admin, nickname, per_page_preference) VALUES (1, 'admin@example.com', '$2y$10$0Men2vJchr82Z7Xfny0VzuVCP.InQphnHztFLSS51TLZycl9JTSnS', false, true, 'admin', 50);
INSERT INTO place (street, number, postcode, city, name) VALUES ('Sesame Street', '1', '12345', 'Sesame', 'Cookie-Storage');
